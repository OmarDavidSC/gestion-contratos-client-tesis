...
export class ETipoContrato {
  ...
  public static parseJson(element: any): ETipoContrato {    
    const objeto = new ETipoContrato();
    objeto.Id = SPParse.getString(element["id"]);
    objeto.Nombre = SPParse.getString(element["nombre"]);
  ...
  public static parseJsonList(elements: any): ETipoContrato[] {

    const lista: ETipoContrato[] = [];

    for (const element of elements) {
      const objeto = ETipoContrato.parseJson(element);
      lista.push(objeto);
    }
