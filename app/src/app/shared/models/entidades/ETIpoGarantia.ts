...
export class ETipoGarantia {
  ...
  public static parseJson(element: any): ETipoGarantia {    
    const objeto = new ETipoGarantia();
    objeto.Id = SPParse.getString(element["id"]);
    objeto.Nombre = SPParse.getString(element["nombre"]);
  ...
  public static parseJsonList(elements: any): ETipoGarantia[] {

    const lista: ETipoGarantia[] = [];

    for (const element of elements) {
      const objeto = ETipoGarantia.parseJson(element);
      lista.push(objeto);
    }
