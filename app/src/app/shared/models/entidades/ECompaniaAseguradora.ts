...
export class ECompaniaAseguradora {
  Id: any;
  Nombre: string;
  Habilitado: Boolean;
  ...
  public static parseJson(element: any): ECompaniaAseguradora {    
    const objeto = new ECompaniaAseguradora();
    objeto.Id = SPParse.getString(element["id"]);
    objeto.Nombre = SPParse.getString(element["nombre"]);
  ...
  public static parseJsonList(elements: any): ECompaniaAseguradora[] {

    const lista: ECompaniaAseguradora[] = [];

    for (const element of elements) {
      const objeto = ECompaniaAseguradora.parseJson(element);
      lista.push(objeto);
    }
