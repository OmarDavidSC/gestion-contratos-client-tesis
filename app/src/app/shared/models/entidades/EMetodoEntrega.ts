...
export class EMetodoEntrega {
  ...
  public static parseJson(element: any): EMetodoEntrega {    
    const objeto = new EMetodoEntrega();
    objeto.Id = SPParse.getString(element["id"]);
    objeto.Nombre = SPParse.getString(element["nombre"]);
  ...
  public static parseJsonList(elements: any): EMetodoEntrega[] {

    const lista: EMetodoEntrega[] = [];

    for (const element of elements) {
      const objeto = EMetodoEntrega.parseJson(element);
      lista.push(objeto);
    }
