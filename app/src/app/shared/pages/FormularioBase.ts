...
import { ModalType } from "../utils/Enumeradores";

export class FormularioBase {
  nombrePagina: string;
  submitted: boolean
 
  constructor(nombrePagina: string, public dialog: MatDialog, public route: ActivatedRoute, public router: Router, public spinner: NgxSpinnerService, public userService: UsuarioService) {
  ...
  async getUser(): Promise<User> {
    return this.userService.getCurrentUser().then((result) => {     
      return User.parseJson(result);
    });
  }
