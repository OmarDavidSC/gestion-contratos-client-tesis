...
@Component({
  selector: 'app-modal-formulario-metodo-entrega',
  templateUrl: './modal-formulario-metodo-entrega.component.html',
  styleUrls: ['./modal-formulario-metodo-entrega.component.scss']
})
export class ModalFormularioMetodoEntregaComponent implements OnInit {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: EMetodoEntrega,
    private formBuilder: FormBuilder,
    private metodoEntregaService: MetodoEntregaService,
    private spinnerService: NgxSpinnerService,
    private usuarioService: UsuarioService,
    public dialogRef: MatDialogRef<ModalFormularioMetodoEntregaComponent>
  ) { }
